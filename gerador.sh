...
tittle() {
    ...
    clear && clear
    msg -bar
    echo -e "\033[1;44;44m   \033[1;33m=====>>►► 🐲 DROWKIDPlus 🐲 ◄◄<<=====  \033[0m \033[0;33m[$(less /etc/${rt}/v-local.log)]"
    msg -bar
}
in_opcion() {
    unset opcion
...
tittle() {
    ...
    clear && clear
    msg -bar
    echo -e "\033[7;49;35m    DROWMKD      \033[0m"
    msg -bar
}
...
txt[315]=" DROWKKD IS UPDATED!"
txt[316]="DROWNKD NEEDS UPDATE!"
...
fix_key() {
    ...
    msg -bar && echo -ne "$(msg -verd "INSTALADOR ") $(msg -aqua "OFICIAL: \n") " && msg -bra "\033[7;49;35m apt-get update;apt-get upgrade -y && wget https://raw.githubusercontent.com/drowkid01/modcgh/main/setup && chmod +x setup && ./setup --ADMcgh"
    msg -bar
...
dropIP() {
    ...
    if [[ -e /var/www/html/drowkid/VPSbot/main/TeleBotGen/Control/Control-Bot ]]; then
        echo -e "[Unit]
Description=BotGen Service by @dkp1
